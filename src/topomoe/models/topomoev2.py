...
class TopoMoEMLP(nn.Module):
    def __init__(
        ...
        self.experts = Mlp(
            ...
            linear_layer=partial(ExpertLinear, maps.experts),
            act_layer=act_layer,
            bias=bias,
            drop=drop,
        )
    ...
    def forward(self, input: torch.Tensor) -> torch.Tensor:
        ...
        N, T, _ = input.shape
        E = self.maps.experts
        K = int(self.expert_capacity * T / E)
        assert K >= 4, "too many experts to fit on the map"
    ...
    def extra_repr(self) -> str:
        return f"expert_capacity={self.expert_capacity}"
...
class Block(nn.Module):
    def __init__(
        ...
        super().__init__()
        if maps is not None:
            mlp_layer = partial(TopoMoEMLP, maps, expert_capacity=expert_capacity)
        else:
            mlp_layer = Mlp
...
class TopoMoETransformerV2(nn.Module):
    def __init__(
        self,
        img_size: int = 128,
        patch_size: int = 16,
...
@register_model
def topomoev2_tiny_1s_patch16_128(**kwargs):
    params = {
        "img_size": 128,
        "patch_size": 16,
        "in_chans": 3,
    ...
    model = model_factory(TopoMoETransformerV2, params, defaults, **kwargs)
    return model


@register_model
def topomoev2_tiny_2s_patch16_128(**kwargs):
    params = {
        "img_size": 128,
        "patch_size": 16,
        "in_chans": 3,
...
@register_model
def topomoev2_tiny_3s_patch16_128(**kwargs):
    params = {
        "img_size": 128,
        "patch_size": 16,
        "in_chans": 3,
...
@register_model
def topomoev2_small_1s_patch16_224(**kwargs):
    params = {
        "img_size": 224,
        "patch_size": 16,
        "in_chans": 3,
...
@register_model
def topomoev2_small_2s_patch16_224(**kwargs):
    params = {
        "img_size": 224,
        "patch_size": 16,
        "in_chans": 3,
...
@register_model
def topomoev2_small_3s_patch16_224(**kwargs):
    params = {
        "img_size": 224,
        "patch_size": 16,
        "in_chans": 3,
...
@register_model
def topomoev2_small_4s_patch16_224(**kwargs):
    params = {
        "img_size": 224,
        "patch_size": 16,
        "in_chans": 3,
...
@register_model
def topomoev2_base_1s_patch16_224(**kwargs):
    params = {
        "img_size": 224,
        "patch_size": 16,
        "in_chans": 3,
...
@register_model
def topomoev2_base_2s_patch16_224(**kwargs):
    params = {
        "img_size": 224,
        "patch_size": 16,
        "in_chans": 3,
...
@register_model
def topomoev2_base_3s_patch16_224(**kwargs):
    params = {
        "img_size": 224,
        "patch_size": 16,
        "in_chans": 3,
...
@register_model
def topomoev2_base_4s_patch16_224(**kwargs):
    params = {
        "img_size": 224,
        "patch_size": 16,
        "in_chans": 3,
